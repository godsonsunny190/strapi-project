...
export interface ApiBannerBanner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MediaFeild: Schema.Attribute.Media<
      'images' | 'videos' | 'audios' | 'files'
    >;
    ProductionDate: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    imagetext: Schema.Attribute.Component<'block.image-content-block', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MediaType: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    RichTest: Schema.Attribute.RichText;
    RichTextBlock: Schema.Attribute.Blocks;
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
    ...
    Type: Schema.Attribute.Enumeration<
      ['Computers', 'Accessrories', 'Others']
    > &
      Schema.Attribute.DefaultTo<'Computers'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
